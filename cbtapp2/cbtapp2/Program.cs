...
dict.Add("7876", "7876");
dict.Add("8855", "8855");
static void QUESTION(string question,string op1,string op2,string op3,string op4)
{
    Console.WriteLine(question, op1, op2, op3, op4);
}
...
while (true)
{
    ...
    QUESTION(" QUESTION 1: An atom consists of how many particles?", "(a)3", "(a)3", "(c)6")
